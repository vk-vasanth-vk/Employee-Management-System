...
const ToastComponent = ({ message, type = "success", show, onClose }) => {
    ...
    return (
        <div id="toast-danger"
             className="absolute flex items-center ml-[600px] w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
             role="alert">
            <div
